...
class Test_Config(unittest.TestCase):
    ...
    def test_multiply_numbers1(self):
        #test that the function multiply num1 and num2 and returns 25
        self.assertEqual(multiply_numbers(5, 5), 25)

    def test_multiply_numbers2(self):
        #test that the function multiply num1 and num2 and returns 100
